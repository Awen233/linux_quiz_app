...
class ContestantHandler extends Thread {
	...
	private void printResponse() {
		...
		sb.append(start + ", " + (callBack.correct * 100)/callBack.numOfPlayer + "% of contestants answered this question correctly. \n");
		sb.append("your score is: " + score + "/" + callBack.contest.question.size() + ". The top score is currently " + callBack.contest.maxScore + "/" +  callBack.contest.question.size());
